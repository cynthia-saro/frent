      ...
      ?>
        <a href="product.php?id=<?php echo $myobject['id'] ?>">
          <div class="object">
            ...
            <?php if ($myobject["status"] == "Réservé") { ?>
              <div class="objBooked"><?php echo $myobject["status"] ?></div>
            <?php } ?>
            <?php if ($myobject["status"] == "Disponible") { ?>
              <div class="objFree"><?php echo $myobject["status"] ?></div>
            <?php } ?>
          </div>
        </a>
      <?php } ?>
