        ...
        <form method="post" action="php/edit_object.php?id=<?php echo $id ?>">
          ...
          <div class="form-group input-group">
            <select class="form-control" name="productStatus" id="productStatus">
              <option value="Réservé" <?php if ($productinfo['status'] == "Réservé") {
                                        echo "selected";
                                      } ?>>Réservé</option>
              <option value="Disponible" <?php if ($productinfo['status'] == "Disponible") {
                                            echo "selected";
                                          } ?>>Disponible</option>
            </select>
          </div>
          ...
          <script>
            $("#productStatus").change(function() {
              if ($("#productStatus").val() == "Réservé") {
                document.getElementById("selectabooker").style.display = "flex";
              }
              if ($("#productStatus").val() == "Disponible") {
                document.getElementById("selectabooker").style.display = "none";
              }
            });
          </script>
          ...
          <div class="form-group input-group">
            ...
            <select class="form-control" name="productCondition" id="productCondition">
              ...
              <option <?php if ($productinfo['obj_condition'] == "Neuf") {
                        echo "selected";
                      } ?>>Neuf</option>
              <option <?php if ($productinfo['obj_condition'] == "Très bon état") {
                        echo "selected";
                      } ?>>Très bon état</option>
              <option <?php if ($productinfo['obj_condition'] == "Correct") {
                        echo "selected";
                      } ?>>Correct</option>
            </select>
          </div>
